class Option < ActiveRecord::Base
  ...
  one_permission(:create){option_owner.nil? || option_owner.send('createable_by?', acting_user)}
  one_permission(:update){option_owner.nil? || option_owner.send('upadateable_by?', acting_user)}
